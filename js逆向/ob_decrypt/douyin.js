    ...
    if (!I) {
      for (; O < E;) {
        ...
        if (x >>= 2, A < 1) {
          ...
          if (x >>= 2, A > 2) {
            (A = x) > 10 ? S[++R] = undefined : A > 1 ? (C = S[R--], S[R] = S[R] >= C) : A > -1 && (S[++R] = null);
          } else {
            if (A > 1) {
              if ((A = x) > 11) {
                throw S[R--];
          ...
          if (A < 2) {
            ...
            if (A < 3) {
              ...
              if (x >>= 2, A > 2) {
                (A = x) > 7 ? (C = S[R--], S[R] = S[R] | C) : A > 5 ? (z = y(b, O), O += 2, S[++R] = c["$" + z]) : A > 3 && (z = s(b, O), t[o][0] && !t[o][2] ? t[o][1] = [O + 4, z - 3] : t[o++] = [0, [O + 4, z - 3], 0], O += 2 * z - 2);
              } else {
                if (A > 1) {
                  if ((A = x) < 2) {
                    ...
                    if (A < 4) {
                      ...
                      A < 6 ? (C = S[R--], S[R] = S[R] % C) : A < 8 ? (C = S[R--], S[R] = S[R] instanceof C) : A < 15 && (S[++R] = false);
                    }
                  }
                } else {
                  if (A > 0) {
              ...
              if (x >>= 2, A > 2) {
                (A = x) > 13 ? (S[++R] = p(b, O), O += 8) : A > 11 ? (C = S[R--], S[R] = S[R] >>> C) : A > 9 ? S[++R] = true : A > 7 ? (z = y(b, O), O += 2, S[R] = S[R][z]) : A > 0 && (C = S[R--], S[R] = S[R] < C);
              } else {
                if (A > 1) {
        ...
        if (x >>= 2, A < 1) {
          ...
          if (x >>= 2, A < 1) {
            ...
            if (A < 2) {
              ...
              if (A < 3) {
                ...
                (A = x) < 1 ? S[++R] = null : A < 3 ? (C = S[R--], S[R] = S[R] >= C) : A < 12 && (S[++R] = undefined);
              }
            }
          }
        } else {
          if (A < 2) {
                ...
                if (A > 0) {
                  if ((A = x) < 8) {
                    ...
                    if (A < 10) {
                      ...
                      A < 12 ? (C = S[R--], S[R] = S[R] << C) : A < 14 && (S[++R] = W[O], O += 2);
                    }
                  }
                } else {
                  if ((A = x) < 5) {
                    ...
                    A < 7 ? (z = W[O], O += 2, S[R -= z] = 0 === z ? new S[R]() : d(S[R], n(S.slice(R + 1, R + z + 1)))) : A < 9 && (C = S[R--], S[R] = S[R] & C);
                  }
                }
              }
            }
            ...
            if (A < 3) {
              ...
              if (x >>= 2, A < 1) {
                (A = x) < 2 ? (C = S[R--], S[R] = S[R] > C) : A < 9 ? (z = W[O], O += 4, q = R + 1, S[R -= z - 1] = z ? S.slice(R, q) : []) : A < 11 ? (z = W[O], O += 2, C = S[R--], c[z] = C) : A < 13 ? (C = S[R--], S[R] = S[R] >> C) : A < 15 && (S[++R] = W[O], O += 4);
              } else {
                if (A < 2) {
                  (A = x) < 1 ? S[++R] = g : A < 3 ? (C = S[R--], S[R] = S[R] + C) : A < 5 ? (C = S[R--], S[R] = S[R] == C) : A < 14 && (C = S[R - 1], q = S[R], S[++R] = C, S[++R] = q);
                } else {
                  if (A < 3) {
                    if ((A = x) < 2) {
                      ...
                      A < 4 ? S[R--] ? O += 4 : O += 2 * (z = W[O]) - 2 : A < 6 ? (C = S[R--], S[R] = S[R] % C) : A < 8 ? (C = S[R--], S[R] = S[R] instanceof C) : A < 15 && (S[++R] = false);
                    }
                  } else {
              ...
              if (x >>= 2, A > 2) {
                (A = x) > 13 ? (S[++R] = W[O], O += 8) : A > 11 ? (C = S[R--], S[R] = S[R] >>> C) : A > 9 ? S[++R] = true : A > 7 ? (z = W[O], O += 2, S[R] = S[R][z]) : A > 0 && (C = S[R--], S[R] = S[R] < C);
              } else {
                if (A > 1) {
                  ...
                  if (A > 0) {
                    ...
                    if ((A = x) < 2) {
                      ...
                      A < 4 ? (C = S[R--], S[R] = S[R] - C) : A < 6 ? (C = S[R--], S[R] = S[R] === C) : A < 15 && (C = S[R], S[R] = S[R - 1], S[R - 1] = C);
                    }
                  }
                }
              }
