!function(_, __) {
    ...
    function Vy_(_, __) {
        // console.log('58行',_,__)
        if (3 == __ || 6 == __ || 28 == __ || 15 == __ || 11 == __ || 13 == __ || 30 == __ || 41 == __) { (u__ = {})._ = __;
    ...
    function V_V(_) {
        ...
        __ += v_V(__u, V__);
        for (var y__ = 0,
        u__ = v_v(v__) - 1; u__ >= 0; u__--) __ += v_V(__U, v__[u__]) * _y_(v_v(__U), y__) * v_v(__u),
        y__ += 1;
        return [__, v_v(___)]
    }
    function V_y(_) {
    ...
    function(_) {
        ...
        function y__(_) {
            if (Array.isArray(_)) {
                for (var __ = 0,
                ___ = Array(v_v(_)); __ < v_v(_); __++) ___[__] = _[__];
                return ___
            }
            return Array.from(_)
        }
        ...
        function _U_(_, ___, v__, V__, y__) {
            ...
            if (Vv_(v__, 32)) {
                ...
                if (29 == __V(_, _u_[2])) var _u_ = __(_u_[1], 15) || __(_u_[1], 11) || __V(_, _u_[1]);
                else _u_ = __(_u_[1], 15) || __(_u_[1], 11) || __(_u_[1], 6);
                u__ = !0
            } else v__ = __(v__, 6);
        ...
        function __v(_, ___, v__) {
            if (v__) var V__ = __(___, 15) || __(___, 11) || __V(_, ___);
            else V__ = __(___, 15) || __(___, 11) || __(___, 6);
            return V__
        }
        function __V(_, v__, u__, __y, __u) {
            ...
            if (43 == __U) u_.map(function(__) {
                ...
                if (36 == __U) if (Vv_(u_[0], 29)) _v = __V(_, u_[1]),
                u_[0][29].map(function(___, v__) {
                    ...
                    if (46 == __U) {
                        ...
                        if (14 == __U) return (_U = u__) && (_U[0] = 1),
                        ___(Vu_ = u_.map(function(__) {
                            return __V(_, __)
                        }));
                        if (4 == __U)(_U = u__) && V__(_U[9], 1);
                        else if (24 == __U)(_U = u__) && V__(_U[35], 1);
                        else {
                            if (18 == __U) {
                                var Vu_ = {};
                            ...
                            if (31 == __U) {
                                ...
                                for (vu_((_U = u__)[9], 0), vu_(_U[35], 0), __V(_, u_[0]); __V(_, u_[1]); __V(_, u_[2])) if (___(_U[35])) V__(_U[35], 0);
                                else {
                                ...
                                var V_u = __V(_, u_[1]);
                                for (var _v in V_u) if (9 == __U && (_v = V_u[_v]), ___(_U[35])) V__(_U[35], 0);
                                else {
                                ...
                                if (0 == __U) {
                                    ...
                                    for (vu_((_U = u__)[9], 0), vu_(_U[35], 0); __V(_, u_[0], _U);) if (___(_U[35])) V__(_U[35], 0);
                                    else {
                                        if (Vu_ = __V(_, u_[1], _U), ___(_U[9])) break;
                                        if (_U[0]) return Vu_
                                    }
                                    ...
                                    if (39 == __U) {
                                            ...
                                            if (5 != ___) {
                                                if (38 == ___) {
                                                    ...
                                                    if (Vv_(v__, 32)) {
                                                        ...
                                                        if (29 == __V(_, y__[2])) var y__ = __(y__[1], 15) || __(y__[1], 11) || __V(_, y__[1]);
                                                        else y__ = __(y__[1], 15) || __(y__[1], 11) || __(y__[1], 6);
                                        ...
                                        if (19 == __U) {
                                            ...
                                            if (42 == __U) return U_ = __(___(u_), 6),
                                            _v = u_[v_v(u_) - 2],
                                            yu_ = u_.slice(0, v_v(u_) - 2),
                                            yU_ = _U__(_, U_, _v, yu_);
                                            if (34 == __U) return _v = ___(u_),
                                            ...
                                            if (40 == __U) {
                                                ...
                                                var v___ = u_.slice(1),
                                                V___ = !1;
                                                for (vu_(_U[9], 0), vu_(_U[35], 0), Vy_ = 0; Vy_ < v_v(v___); Vy_++) if (___(_U[35])) V__(_U[35], 0);
                                                else {
                                                ...
                                                if (44 == __U) debugger;
                                                    ...
                                                    if (32 == __U) {
                                                        ...
                                                        u__ ? (vu_(_v__, _v), [yU_, yU_[_v]]) : (_v__.map(function(_) {
                                                            return yU_ = yU_[0],
                                                            _
                                                        }).map(function(_) {
                                                            yU_ = yU_[_]
        ...
        var __, ___, v__, V__ = V_U(_, 0),
        y__ = V__[0],
        u__ = V__[1];
        console.log(__, ___, v__, V__)
        for (y__ = function(_) {
